...
cd /usr/bin
wget -O addss-p "https://raw.githubusercontent.com/Kulanbagong1/VpnJKLO/main/shadowsocks-plugin/addss-p.sh"
chmod +x addss-p
...
wget -O delss "https://raw.githubusercontent.com/Kulanbagong1/VpnJKLO/main/shadowsocks/delss.sh"
cd
